...
class Patcherly_PatchApplicator {
    ...
    private function is_path_safe($filePath) {
        ...
        // Ensure file is within WordPress root
        return strpos($realPath, $realAbspath) === 0;
    }
    ...
    private function parseHunk($lines, $startIdx) {
        ...
        return new Patcherly_Hunk($origStart, $origLen, $newStart, $newLen, $context, $removed, $added);
    }
