...
(function () {
  ...
  var TOUR = [
    ...
    { selector: '[data-tour="bulk"]', title: 'Bulk delete', body: 'Tick the boxes and click "Delete selected" to clear resolved or noisy rows in one pass. Important: in the real Patcherly product Delete is dashboard-only — a hard delete of the row (no trash, no undo) recorded in your audit trail. It does NOT roll back a patch already applied to your site (use Rollback for that), does NOT refund a fix to your monthly quota, and does NOT touch the pre-apply backups Patcherly keeps on your own server.' },
